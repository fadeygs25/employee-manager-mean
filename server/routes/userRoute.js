...
const { isAuthenticated, isAuthenticatedReqId, isAdmin } = require("../middleware/auth");
...
router.get('/userReqToken/:id', isAuthenticatedReqId, userProfile);
router.get('/users/all/:id', isAuthenticatedReqId, allUsers);
